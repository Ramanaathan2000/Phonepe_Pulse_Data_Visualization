...
with st.sidebar:
    select= option_menu("Main Menu",["About", "Data APIs", "Insights"])
...
if select == "About":
    ...
    with col2:
        st.image("phonepe.jpg",caption="PHONEPE PULSE",width =500,channels="RGB",output_format="auto")
        st.video("C:\\Users\\raman\\OneDrive\\Desktop\\GUVI DOCX\\New folder\\phonepe\\phonepe1\\Introducing PhonePe Pulse.mp4")

    col3,col4= st.columns(2)
    
    with col3:
        st.video("C:\\Users\\raman\\OneDrive\\Desktop\\GUVI DOCX\\New folder\\Phonepe\\phonepe1\\PhonePe Motion Graphics.mp4")
